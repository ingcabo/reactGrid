...
export const loadProducst = () =>{
   const products = [
      ...
      { id:14, name: "Plantronics Headsets", price: 56, image: "https://pisces.bbystatic.com/image2/BestBuy_US/store/ee/2016/aud/pr/152565-Plantronics/152565-Plantronics-flex-Console_Gaming.jpg;maxHeight=291;maxWidth=291"},
      { id:15, name: "Dell N5050", price: 149, image: "http://d2pa5gi5n2e1an.cloudfront.net/global/images/product/laptops/Dell_Inspiron_N4050/Dell_Inspiron_N4050_L_1.jpg" },
      { id:16, name: "Batidora Amasadora Kitchenaid Artis", price: 34, image: "https://http2.mlstatic.com/batidora-amasadora-kitchenaid-artisan-220v-5-litros-evotech-D_NQ_NP_926311-MLA26336076317_112017-F.jpg" },
      { id:17, name: "MAQUINA TORTILLADORA MANUAL", price: 12, image: "https://i.ytimg.com/vi/I_ziSXCWUgY/hqdefault.jpg" },
      { id:18, name: "Picador PApas Fritas", price: 37, image: "https://www.uniworldespanol.com/s/cc_images/teaserbox_4092711584.jpg?t=1423157884" }
    ];
    return {
...
/*
export const loadProducst = () =>{
      axios.get("https://proyectocaslos.firebaseio.com/products.json")
      .then(response => {
